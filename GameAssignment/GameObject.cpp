...
//                    float centerX = static_cast<float>(platformBoundingBoxes[i].left + platformBoundingBoxes[i].right) / 2.0f;
//                    float centerY = static_cast<float>(platformBoundingBoxes[i].top + platformBoundingBoxes[i].bottom) / 2.0f;
//
